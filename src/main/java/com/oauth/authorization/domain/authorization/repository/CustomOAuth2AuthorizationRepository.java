...
public class CustomOAuth2AuthorizationRepository {
    ...
    public void save(String tenantId, CustomOAuth2Authorization newCustomOAuth2Authorization) {
    ...
    private CustomOAuth2Authorization findByRefreshToken(String token) {
        ElasticSearchToken elasticSearchToken = elasticSearchTokenRepository.findByRefreshToken(token)
    ...
    public void delete(String tenantId, CustomOAuth2Authorization oAuth2Authorization) {
        oauthAuthorizationRepository.delete(tenantId, oAuth2Authorization);
    }
}
