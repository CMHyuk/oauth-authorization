...
public class CustomOAuth2AuthorizationMapper {
    ...
    public CustomOAuth2Authorization create(String tenantId, OAuth2Authorization.Token<OAuth2AuthorizationCode> token, String state, String authorizationId, OAuth2Authorization authorization) {
